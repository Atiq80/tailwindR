...
<body class="font-poppins">
    ...
    <div style="background-image: url(bg-registration-form-1.jpg); background-position: top; background-size: cover;"
        ...
        <div class="inner sm:flex sm:items-center sm:h-fit  w-full  h-full bg-white lg:w-[62%] lg:h-[28.5rem] xl:h-[32rem]">
            ...
            <div class="lg:mr-4">
                ...
                <form method="_POST" class="mx-5 lg:mx-7 mt-10 lg:mt-5  h-full ">


                    <div class="flex justify-center gap-5 ">
                        <input type="text" class="w-full border-b border-[#333] pb-1 lg:pb-[3.3px] outline-none "
                    ...
                    <div class=" w-full mt-5 lg:mt-[14.5px] relative flex">
                        ...
                        <input type="email" class="w-full border-b border-[#333] pb-1 lg:pb-[3.3px] outline-none "
                    ...
                    <div class="w-full mt-5 lg:mt-[14.5px] relative flex">
                        <select id="genderSelect"
                            class="w-full border-b text-[12px]  border-[#333] text-[#333] absolute pb-1 lg:pb-[3.3px] outline-none">
                        ...
                        <input type="text" id="genderInput"
                            class="w-full outline-none border-b border-[#333] text-[12px] text-[#333]  pb-1 lg:pb-[3.3px]"
                    ...
                    <div class=" w-full mt-5 lg:mt-[14.5px] relative flex">
                        ...
                        <input type="password" class="w-full border-b border-[#333] pb-1 lg:pb-[3.3px] outline-none "
                            required placeholder="Password"  name="p" >
                    ...
                    <div class="flex items-center  group  justify-center mt-8 pb-7 ">
                        ...
                        <input
                            ...
                            type="button" name="btn" value="Register ">
                        <span
...
if (isset($_POST["btn"])) {
    ...
    $sql = "INSERT INTO `details` (`firstname`, `lastname`, `username`, `gender` , `email`, `pass` , `rpass`) 
            VALUES ( '$firstname' , '$lastname' , '$username' , '$gender' , '$email' , '$pass' , '$rpass' )";
